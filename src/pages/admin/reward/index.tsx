...
import { getFileNameFromUrl } from '@/components/post/post-item';
...
const AdminRewardPage = () => {
    ...
    const columns: ColumnsType<RedeemDocument> = [
        ...
        },
        {
            ...
            dataIndex: 'price',
            key: 'price',
            render: (price: number) => numberFormat(price, ',') + ' MC',
        },
        {
            title: 'Created Date',
                ...
                <Form layout="vertical" form={form} name="reward-form" onFinish={onFinishUpdate}>
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                            ...
                            <Upload
                                fileList={anotherFileList.map(file => ({
                                    ...file,
                                    name: file.url ? getFileNameFromUrl(file.url) : file.name,
                                }))}
                                onRemove={onRemoveAnotherFile}
                            ></Upload>
                        </Col>
